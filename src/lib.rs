...
#[derive(Debug)]
pub struct BertVITS2Processor {
    verbose: bool,
    processed_count: usize,
}

impl BertVITS2Processor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting BertVITS2 processing");
    
    let mut processor = BertVITS2Processor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = BertVITS2Processor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = BertVITS2Processor::new(false);
